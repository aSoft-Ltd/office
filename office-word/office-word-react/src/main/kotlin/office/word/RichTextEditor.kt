...
import theme.*
import office.word.RichTextEditor.Props
import office.word.RichTextEditor.State
import kotlin.math.max

@JsExport
class RichTextEditor private constructor(p: Props) : Component<Props, State>(p) {
...
fun RBuilder.MiniWordEditor(
    content: String? = null,
    onSubmit: (String) -> Unit
) = child(RichTextEditor::class.js, Props(content, RichTextEditorType.Post(onSubmit)) { MiniWordEditorToolbar(it) }) {}
